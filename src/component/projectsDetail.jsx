  ...
  return (
    <Grid container direction="row-reverse">
      <Grid
        ...
        lg={4}
        xl={4}
        id="pot" /*className="project-page-details"*/
      >
        <div style={{ textAlign: "right" }}>
          <button onClick={history.goBack}>X</button>
        </div>
        <div
          style={{ textAlign: "center", margin: "50px 0px", padding: "0px 5%" }}
        >
          <h1>{props.name}</h1>
          <h3>{props.details}</h3>
          <div style={{ display: "flex", justifyContent: "center" }}>
            {props.Link ? (
              ...
              <h2 style={{ backgroundColor: "gray" }}> Not Available</h2>
            )}
            {props.Git ? (
              <img
                onClick={() => {
                  window.open(props.Git);
                }}
